...
{
    // RGBHex(0x999999)
    self.placeholder_color =HKRGBColor(210, 210, 215);
...
//    self.maxTextLength=[@"10" integerValue];
   

    if (self.jianLinLength!=0) {
         if (self.text.length > self.jianLinLength) {
         self.text = [ self.text substringToIndex:self.jianLinLength];
        }
