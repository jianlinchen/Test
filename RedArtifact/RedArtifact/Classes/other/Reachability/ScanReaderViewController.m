...
//    CGPoint point = CGPointMake(APP_W/2, self.view.center.y - 180);
    CGPoint point = CGPointMake(APP_W/2, 100);
...
//    
//    [HttpRequest getWebData:[GLOBARMANAGER AppKeyTokenDic:dic] path:ScanOr method:@"GET" success:^(id object) {
//        if (object) {
...
//    
//    [HttpRequest getWebData1:[GLOBARMANAGER AppKeyTokenDic:dic] path:Verifyinfo method:@"GET" success:^(id object) {
